...
uint8_t ST25R3911B_14A4_AdjustBitRate(ST25R *pInstance, T4A_INFOS *pt4aInfos, ST25R_BITRATE bitrate)
{
	...
	if(pt4aInfos->CurrentBitrate != bitrate)
	{
		...
		if(ret == ST25R_STATUS_NO_ERROR)
		{
			...
			case ST25R_BITRATE_848:
				ST25R3911B_14A_TxRx848(pInstance);
				break;

			case ST25R_BITRATE_424:
				ST25R3911B_14A_TxRx424(pInstance);
				break;

			case ST25R_BITRATE_212:
				ST25R3911B_14A_TxRx212(pInstance);
				break;
