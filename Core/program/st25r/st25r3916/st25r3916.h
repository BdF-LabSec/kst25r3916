...
#define ST25R3916_DirectCommand(s, cmd)								ST25R_SPI_DirectCommand_internal((s), ST25R3916_MK_CMD(cmd))
#define ST25R3916_Read_SingleRegister(s, reg)						ST25R_SPI_Read_SingleRegister_internal((s), 0, ST25R3916_MK_READ(reg))
#define ST25R3916_Write_SingleRegister(s, reg, value)				ST25R_SPI_Write_SingleRegister_internal((s), 0, ST25R3916_MK_WRITE(reg), (value))

#define ST25R3916_Write_Registers2(s, reg, value)					ST25R_SPI_Write_Registers2_internal((s), 0, ST25R3916_MK_WRITE(reg), (value))
#define ST25R3916_Write_Registers2_sep(s, reg, v1, v2)				ST25R3916_Write_Registers2(s, reg, \
			((v1) <<  0) | \
			((v2) <<  8) \
	)
#define ST25R3916_Write_Registers4(s, reg, value)					ST25R_SPI_Write_Registers4_internal((s), 0, ST25R3916_MK_WRITE(reg), (value))
...
#define ST25R3916_Read_SingleRegisterB(s, reg)						ST25R_SPI_Read_SingleRegister_internal((s), ST25R3916_MK_CMD(ST25R3916_CMD_SPACE_B_ACCESS), ST25R3916_MK_READ(reg))
#define ST25R3916_Write_SingleRegisterB(s, reg, value)				ST25R_SPI_Write_SingleRegister_internal((s), ST25R3916_MK_CMD(ST25R3916_CMD_SPACE_B_ACCESS), ST25R3916_MK_WRITE(reg), (value))

#define ST25R3916_Write_RegistersB2(s, reg, value)					ST25R_SPI_Write_Registers2_internal((s), ST25R3916_MK_CMD(ST25R3916_CMD_SPACE_B_ACCESS), ST25R3916_MK_WRITE(reg), (value))
#define ST25R3916_Write_RegistersB2_sep(s, reg, v1, v2)				ST25R3916_Write_RegistersB2(s, reg, \
			((v1) <<  0) | \
			((v2) <<  8) \
	)
#define ST25R3916_Write_RegistersB4(s, reg, value)					ST25R_SPI_Write_Registers4_internal((s), ST25R3916_MK_CMD(ST25R3916_CMD_SPACE_B_ACCESS), ST25R3916_MK_WRITE(reg), (value))
...
#define ST25R3916_Read_SingleRegisterTEST(s, reg)					ST25R_SPI_Read_SingleRegister_internal((s), ST25R3916_MK_CMD(ST25R3916_CMD_TEST_ACCESS), ST25R3916_MK_READ(reg))
#define ST25R3916_Write_SingleRegisterTEST(s, reg, value)			ST25R_SPI_Write_SingleRegister_internal((s), ST25R3916_MK_CMD(ST25R3916_CMD_TEST_ACCESS), ST25R3916_MK_WRITE(reg), value)
...
#define ST25R3916_Read_IRQ(s)										ST25R_SPI_Read_IRQ_internal((s), ST25R3916_MK_READ(ST25R3916_REG_IRQ_MAIN), ST25R_IRQ_CB_4)
#define ST25R3916_Mask_IRQ(s, mask, op)								ST25R_SPI_Write_IRQ_Mask_Operation_internal((s), (mask), (op), ST25R3916_MK_WRITE(ST25R3916_REG_IRQ_MASK_MAIN), ST25R_IRQ_CB_4)

#define ST25R3916_Write_NoResponseTimer(s, v)						ST25R3916_Write_Registers2((s), ST25R3916_MK_WRITE(ST25R3916_REG_NO_RESPONSE_TIMER1), __builtin_bswap16(v))
#define ST25R3916_Write_GeneralPurposeTimer(s, v)					ST25R3916_Write_Registers2((s), ST25R3916_MK_WRITE(ST25R3916_REG_GPT1), __builtin_bswap16(v))
...
/* DS12484 # 4.3.3 - Serial peripheral interface (SPI) - Table 11 */

#define ST25R3916_MASK_ADDRESS		0b00111111
#define ST25R3916_MASK_COMMAND		0b00111111

#define ST25R3916_WRITE_MODE		(0b00 << 6)
#define ST25R3916_READ_MODE			(0b01 << 6)
#define ST25R3916_CMD_MODE			(0b11 << 6)
#define ST25R3916_FIFO_LOAD			0b10000000
#define ST25R3916_FIFO_READ			0b10011111
#define ST25R3916_PT_A_CONFIG_LOAD	0b10100000
#define ST25R3916_PT_F_CONFIG_LOAD	0b10101000
#define ST25R3916_PT_TSN_DATA_LOAD	0b10101100
#define ST25R3916_PT_MEM_READ		0b10011111

#define ST25R3916_MK_WRITE(reg)		(((reg) & ST25R3916_MASK_ADDRESS) | ST25R3916_WRITE_MODE)
#define ST25R3916_MK_READ(reg)		(((reg) & ST25R3916_MASK_ADDRESS) | ST25R3916_READ_MODE)
#define ST25R3916_MK_CMD(cmd)		(((cmd) & ST25R3916_MASK_COMMAND) | ST25R3916_CMD_MODE)
...
#define ST25R3916_REG_B_EMD_SUP_CONF       (0x05U)   /*!< RW EMD Suppression Configuration Register            */
#define ST25R3916_REG_B_SUBC_START_TIME    (0x06U)   /*!< RW Subcarrier Start Time Register                    */
#define ST25R3916_REG_B_P2P_RX_CONF        (0x0BU)   /*!< RW P2P Receiver Configuration Register 1             */
#define ST25R3916_REG_B_CORR_CONF1         (0x0CU)   /*!< RW Correlator configuration register 1               */
#define ST25R3916_REG_B_CORR_CONF2         (0x0DU)   /*!< RW Correlator configuration register 2               */
#define ST25R3916_REG_B_SQUELCH_TIMER      (0x0FU)   /*!< RW Squelch timeout Register                          */
#define ST25R3916_REG_B_FIELD_ON_GT        (0x15U)   /*!< RW NFC Field on guard time                           */
#define ST25R3916_REG_B_AUX_MOD            (0x28U)   /*!< RW Aux Modulation setting Register                   */
#define ST25R3916_REG_B_TX_DRIVER_TIMING   (0x29U)   /*!< RW TX driver timing Register                         */
#define ST25R3916_REG_B_RES_AM_MOD         (0x2AU)   /*!< RW Resistive AM modulation register                  */
#define ST25R3916_REG_B_TX_DRIVER_STATUS   (0x2BU)   /*!< R  TX driver timing readout Register                 */
#define ST25R3916_REG_B_REGULATOR_RESULT   (0x2CU)   /*!< R Regulator Display Register                         */
#define ST25R3916_REG_B_OVERSHOOT_CONF1    (0x30U)   /*!< RW  Overshoot Protection Configuration Register 1    */
#define ST25R3916_REG_B_OVERSHOOT_CONF2    (0x31U)   /*!< RW  Overshoot Protection Configuration Register 2    */
#define ST25R3916_REG_B_UNDERSHOOT_CONF1   (0x32U)   /*!< RW  Undershoot Protection Configuration Register 1   */
#define ST25R3916_REG_B_UNDERSHOOT_CONF2   (0x33U)   /*!< RW  Undershoot Protection Configuration Register 2   */

/* Register Address Test */
#define ST25R3916_REG_T_ANALOG_TEST_AND_OBSERVATION_1			0x01U
#define ST25R3916_REG_T_unk_INCLUDING_OVERHEAT_PROTECTION		0x04U
